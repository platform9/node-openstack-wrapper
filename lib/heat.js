...
//  }
//}
Heat.prototype.listStacks = function(filters, cb)
{
  var self = this;
...
//takes optional object that contains optional parameters
// i.e.
// {
//   disable_rollback: '',
//   environment: '',
...
//calls back with cb(error, stack_object)
//takes object that contains optional parameters.
// i.e.
// {
//   disable_rollback: '',
//   environment: '',
...
//   parameters: '',
//   tags: '',
//   template: 'if defined, overrides template_url',
//   template_url: 'required only if template is omitted',
//   timeout_mins: ''
//}
...
Heat.prototype.deleteStack = function(name, id, cb)
{
  ...
  if (typeof id != 'string') {
      throw new Error('heat.createStack: requires `id`  (string) parameter');
  }
